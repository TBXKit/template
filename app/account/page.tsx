...
export default async function AccountPage() {
  ...
  return (
    <div className="mx-auto max-w-md px-6 py-16">
      ...
      {/*
        Purchase history isn't shown: confirmed (ROADMAP.md Phase 9.1) that
        it's not exposed by the public-token Headless API this storefront
        uses — it lives behind the separate Plugin API's X-Tebex-Secret
        private key instead, which this project deliberately doesn't hold
        (see AGENTS.md). Stated plainly rather than silently omitted.
      */}
